...
public class Service {
	...
	public boolean virementCompte (Compte compte1, Compte compte2, double montant) throws IndexOutOfBoundsException{
		CompteDao v = new CompteDao();
		v.retraitDao(compte1, montant);
		v.virementDao(compte2, montant);
